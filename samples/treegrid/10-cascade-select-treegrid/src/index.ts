...
class CascadeSelectApp extends Application {
  constructor() { super({ name: 'CascadeSelectTreeGrid', theme: ModernTheme }); }
...
if (import.meta.env.MODE !== 'test') new CascadeSelectApp().start();
