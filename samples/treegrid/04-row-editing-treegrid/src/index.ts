...
class RowEditingApp extends Application {
  constructor() { super({ name: 'RowEditingTreeGrid', theme: ModernTheme }); }
...
if (import.meta.env.MODE !== 'test') new RowEditingApp().start();
