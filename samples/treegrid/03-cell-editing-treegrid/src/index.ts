...
class CellEditingApp extends Application {
  constructor() { super({ name: 'CellEditingTreeGrid', theme: ModernTheme }); }
...
if (import.meta.env.MODE !== 'test') new CellEditingApp().start();
