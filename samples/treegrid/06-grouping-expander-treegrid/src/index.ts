...
class GroupingExpanderApp extends Application {
  constructor() { super({ name: 'GroupingExpanderTreeGrid', theme: ModernTheme }); }
...
if (import.meta.env.MODE !== 'test') new GroupingExpanderApp().start();
