...
class SelectionTreeGridApp extends Application {
  constructor() { super({ name: 'SelectionTreeGrid', theme: ModernTheme }); }
...
if (import.meta.env.MODE !== 'test') new SelectionTreeGridApp().start();
